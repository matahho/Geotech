...
from PyQt5.QtGui import QIntValidator, QDoubleValidator, QFont, QPalette, QColor , QCursor , QPixmap
...
class Module2(QWidget):
    ...
    def __init__(self, parent):
        ...
        self.layout.addWidget(self.module2)
    ...
    def passShapeToWindow (self , XQp , YQp , colorQp , XQf , YQf , colorQf , XQu , YQu , colorQu , XQall , YQall , colorQall):
        QperPile = Figure (figsize=(8 , 12) , dpi=100)
