...
class App(QMainWindow):
    ...
    def __init__(self):
        ...
        self.table_widget = Module3(self)
...
class Module3(QWidget):
    ...
    def __init__(self, parent):
        ...
        #self.layout.addWidget(self.HomeHelp , alignment = Qt.AlignRight)
        ...
        #self.module3Help.clicked.connect(self.module3HelpFunction2)
        

        # Create first tab
        self.module3.layout = QGridLayout(self)
        self.module3.layout.addWidget(self.module3Help ,0 , 0 , alignment = Qt.AlignRight)
